            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div class="page-title-left">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"> Detail Pendidikan</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 mb-3">
                    <div class="form-group">
                        <div><span class="fw-bold">Jenjang Pendidikan :</span></div>
                        <small>{{ $data->edu_grade ?? '-' }}</small>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3 mb-3">
                    <div class="form-group">
                        ...
                        <small>{{ $data->edu_institution ?? '-' }}</small>
                    </div>
                </div>
                <div class="col-lg-3 mb-3">
                    <div class="form-group">
                        <div><span class="fw-bold">Kota / Provinsi :</span></div>
                        <small>{{ $data->edu_city ?? '-' }}</small>
                    </div>
                </div>
                <div class="col-lg-3 mb-3">
                    <div class="form-group">
                        <div><span class="fw-bold">Jurusan :</span></div>
                        <small>{{ $data->edu_major ?? '-' }}</small>
                    </div>
                </div>
                <div class="col-lg-3 mb-3">
                    <div class="form-group">
                        <div><span class="fw-bold">Periode (Tahun) :</span></div>
                        <small>{{ $data->edu_start_year ?? '-' }} - {{ $data->edu_end_year ?? '-' }}</small>
                    </div>
                </div>
            </div>
            <hr>
