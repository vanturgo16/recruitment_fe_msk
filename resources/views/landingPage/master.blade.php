...
<html lang="en">
    <head>
		...
		<title>Home | Recruitment PT MSK</title>
		
		<!-- Color modes -->
		<script src="{{ asset('assets/js/vendors/color-modes.js') }}"></script>
		<!-- Libs CSS -->
		<link href="{{ asset('assets/libs2/simplebar/dist/simplebar.min.css') }}" rel="stylesheet" />
		<link href="{{ asset('assets/libs2/bootstrap-icons/font/bootstrap-icons.min.css') }}" rel="stylesheet" />
		<!-- Scroll Cue -->
		<link rel="stylesheet" href="{{ asset('assets/libs2/scrollcue/scrollCue.css') }}" />
		<!-- Box icons -->
		...
		<header>
			<nav class="navbar navbar-expand-lg navbar-light w-100">
			   <div class="container px-3">
				  <a class="navbar-brand " href="{{ route('home') }}"><img class="offcanvas-logo" src="{{ asset('assets/images/logo/logo_horizontal_light.png') }}" alt /></a>
		...
		<footer class="pt-7">
				  ...
				  <div class="col-lg-3 col-12">
					 <div class="me-7">
						...
						<p class="text-body-secondary">
							<b>PT. Mitra Sendang Kemakmuran</b>
							<br>
			...
			<div class="container mt-7 pt-lg-7 pb-4">
			   <div class="row align-items-center">
				  <div class="col-md-3">
					 <a class="mb-4 mb-lg-0 d-block text-inverse" href="index.html"><img src="{{ asset('assets/images/logo/logo.svg') }}"
						   alt="" /></a>
				  </div>
